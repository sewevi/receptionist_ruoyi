<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="标题简介" prop="titleSynopsis">
        <el-input
          v-model="queryParams.titleSynopsis"
          placeholder="请输入标题简介"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="业务地址" prop="businessUrl">
        <el-input
          v-model="queryParams.businessUrl"
          placeholder="请输入业务地址"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="businessList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标题简介" align="center" prop="titleSynopsis" />
      <el-table-column label="内容" align="center" prop="content" />
      <el-table-column label="图标地址" align="center" prop="icon" />
      <el-table-column label="业务地址" align="center" prop="businessUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="标题简介" prop="titleSynopsis">
          <el-input v-model="form.titleSynopsis" placeholder="请输入标题简介" />
        </el-form-item>
        ...
        <el-form-item label="业务地址" prop="businessUrl">
          <el-input v-model="form.businessUrl" placeholder="请输入业务地址" />
        </el-form-item>
...
<script>
import { listBusiness, getBusiness, delBusiness, addBusiness, updateBusiness, exportBusiness } from "@/api/system/business";
